...
EN_NARRATION = {
    ...
    27: "Tap Photo 1: Dial. Frame the dial straight-on with even light — one clear photo is enough to start.",
    29: "If HHH asks for a movement photo, add one — or skip and continue with the dial.",
    31: "Scroll to Wristwatch, Pocket Watch, or Clock if the type is wrong.",
    32: "Scroll down past brand and model. Tap Identify. Wait while it works.",

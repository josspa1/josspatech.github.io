...
ALT_MAP: list[tuple[str, str]] = [
    ...
    ("scan", "/assets/screenshots/receipt-scanning/receipt-scan.png"),
    ("escáner", "/assets/screenshots/receipt-scanning/receipt-scan.png"),
    ("扫描", "/assets/screenshots/receipt-scanning/receipt-scan.png"),
    ("scanning", "/assets/screenshots/receipt-scanning/receipt-scan.png"),
    ...
    ("bill", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ("factura", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ("账单", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ("recurring", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ...
    ("report", "/assets/screenshots/reports/reports.png"),
    ("informe", "/assets/screenshots/reports/reports.png"),
    ("报告", "/assets/screenshots/reports/reports.png"),
    ...
    ("calendar", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ("calendario", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ("日历", "/assets/screenshots/bills-recurring/bills-calendar.png"),
    ...
    ("data", "/assets/screenshots/import.png"),
    ("storage", "/assets/screenshots/import.png"),
    ("almacenamiento", "/assets/screenshots/import.png"),
    ("datos", "/assets/screenshots/import.png"),
    ("数据", "/assets/screenshots/import.png"),
    ("存储", "/assets/screenshots/import.png"),
    ("help", DASH),
    ("ayuda", DASH),
    ("帮助", DASH),
    ("accessib", DASH),

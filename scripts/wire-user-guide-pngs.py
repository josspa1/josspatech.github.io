...
ALT_MAP: list[tuple[str, str]] = [
    ...
    ("scan", "/assets/screenshots/pbj/02-import-center.png"),
    ("escáner", "/assets/screenshots/pbj/02-import-center.png"),
    ("扫描", "/assets/screenshots/pbj/02-import-center.png"),
    ("scanning", "/assets/screenshots/pbj/02-import-center.png"),
    ...
    ("invest", "/assets/screenshots/pbj/06-goals-languages.png"),
    ("inversion", "/assets/screenshots/pbj/06-goals-languages.png"),
    ("投资", "/assets/screenshots/pbj/06-goals-languages.png"),
    ...
    ("household", "/assets/screenshots/pbj/07-web-companion.png"),
    ("hogar", "/assets/screenshots/pbj/07-web-companion.png"),
    ("家庭", "/assets/screenshots/pbj/07-web-companion.png"),

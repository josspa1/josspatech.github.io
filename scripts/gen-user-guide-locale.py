...
LOCALES = {
    ...
    "it": {
        ...
        "cards": [
            ...
            ("Importare dati", "Importa estratti CSV, OFX, QFX, QIF, XLSX o PDF — nessun login bancario. Smart Mapper rileva le colonne. Rilevamento duplicati evita conteggi doppi. Importa almeno tre mesi di storico. Sincronizzazione bancaria automatica (solo USA, via Teller) è opzionale con Premium a pagamento — non durante la prova di 21 giorni. Vedi il nostro <a href=\"/videos/user-guide/#chapter=54\" style=\"color: #1A4F7A; font-weight: 600; text-decoration: underline;\">video sull'importazione dati bancari</a>."),
